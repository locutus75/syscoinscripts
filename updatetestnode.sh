...
wget https://github.com/syscoin/syscoin/releases/download/v4.4.0rc${RC}/syscoin-4.4.0rc${RC}-x86_64-linux-gnu.tar.gz
sleep 2

echo -e "${CYAN}Unpacking...${NC}"
tar xf syscoin-4.4.0rc${RC}-x86_64-linux-gnu.tar.gz

echo -e "${CYAN}Installing...${NC}"
sleep 2
sudo install -m 0755 -o root -g root -t /usr/local/bin syscoin-4.4.0rc${RC}/bin/*

echo -e "${CYAN}Cleaning up...${NC}"
sleep 2
rm -r syscoin-4.4.0rc${RC}
rm ~/syscoin-4.4.0rc${RC}-x86_64-linux-gnu.tar.gz
